(function () {
	...
	GaugeChartHelper.prototype.applyGaugeConfig = function(chartConfig) {
		...
		if(!chartConfig.options.sizeRatio)
			chartConfig.options.sizeRatio = 100;
		var ctx = this.ctx;
		...
		var heightRatio = this.chart.height / (chartConfig.options.sizeRatio / 2);
	...
	GaugeChartHelper.prototype.renderValueLabel = function() {
		...
		var elementWidth = 0.5 * this.gaugeRadius * 2;
	...
	GaugeChartHelper.prototype.renderArrow = function(radius, angle, arrowLength, arrowAngle, arrowColor) {
		var coord = this.getCoordOnCircle(radius-3, angle);
		var arrowPoint = {
		...
		coord = this.getCoordOnCircle(arrowLength + 25, angle + arrowAngle + 125);
